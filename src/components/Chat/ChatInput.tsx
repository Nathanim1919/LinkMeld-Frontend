...
export const ChatInput = () => {
    ...
    return (
      <div className="px-4 py-4 border-t border-gray-800 bg-black/50 backdrop-blur-lg">
        {/* Suggested Prompts */}
        ...
        <div className="relative">
          <textarea
            ...
            className="w-full bg-gray-800/70 backdrop-blur-md rounded-xl border border-gray-700/50 text-white py-2 px-4 pr-12 resize-none focus:outline-none focus:ring-1 focus:ring-gray-600 focus:border-transparent"
