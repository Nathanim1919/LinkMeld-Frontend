    ...
    <>
      ...
      <section
        className={clsx(
          ...
          {
            "lg:grid-cols-[0.0fr_1fr]": isProfileRoute,
            "lg:grid-cols-[0fr_0fr_1fr]":
              collapsed && middlePanelCollapsed && !isProfileRoute,
            "lg:grid-cols-[0fr_0.3fr_1fr]":
              collapsed && !middlePanelCollapsed && !isProfileRoute,
            "lg:grid-cols-[0.15fr_0fr_1fr]":
              !collapsed && middlePanelCollapsed && !isProfileRoute,
            "lg:grid-cols-[0.15fr_0.3fr_1fr]":
              !collapsed && !middlePanelCollapsed && !isProfileRoute,
          }
        )}
      >
