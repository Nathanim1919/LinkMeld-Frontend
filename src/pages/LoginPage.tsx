...
import { FiArrowRight, FiMail, FiLock, FiEye, FiEyeOff, FiGithub, FiTwitter } from "react-icons/fi";
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex items-center justify-center p-6 relative overflow-hidden isolate">
      ...
      <div className="absolute inset-0 -z-20">
        <div className="absolute top-1/3 left-1/2 w-[1200px] h-[1200px] bg-[radial-gradient(circle_at_center,#7F5AF0_0%,transparent_70%)] opacity-[0.03] blur-[200px]" />
      ...
      >
        ...
        <div className="bg-[#0A0A0A] border border-white/5 rounded-2xl p-8 shadow-2xl backdrop-blur-sm">
          ...
          >
            ...
            >
              Cross the Threshold <FiArrowRight />
            </motion.button>
          </motion.form>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              { provider: "Twitter", icon: <FiTwitter /> },
              { provider: "GitHub", icon: <FiGithub /> }
            ].map((item) => (
              <motion.button
                key={item.provider}
                whileHover={{ y: -2 }}
